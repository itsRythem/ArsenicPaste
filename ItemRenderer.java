...
import com.arsenicclient.module.impl.render.Animations;
...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            GlStateManager.pushMatrix();
            Animations a = (Animations) Arsenic.getArsenic().getModuleManager().getModule("Animations");
            
			if (a.isEnabled())
				GlStateManager.translate(a.x.getValue() / 5 - (a.z.getValue() / 12),
						a.y.getValue() / 5 + (a.z.getValue() / 12), a.z.getValue() / 5);
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0)
                {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                        	...
                        	float d = MathHelper.sin(f1 * f1 * (float)Math.PI);
            		        float d1 = MathHelper.sin(MathHelper.sqrt_float(f1) * (float)Math.PI);
            		        float d2 = MathHelper.cos(MathHelper.sqrt_float(f1) * (float)Math.PI);
                        	
                            if(a.isEnabled()) {
                            	GlStateManager.translate(0, a.by.getValue() / 5 + (a.z.getValue() / 12), 0);
                            	GlStateManager.translate(0.56F, -0.52F, -0.71999997F);
                                GlStateManager.translate(0.0F, f * -0.6F, 0.0F);
                                GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
                            	switch(a.mode.getMode()) {
                            	case "1.7":
                            		GlStateManager.rotate(d * -20.0F, 0.0F, 1.0F, 0.0F);
                                    GlStateManager.rotate(d1 * -20.0F, 0.0F, 0.0F, 1.0F);
                                    GlStateManager.rotate(d1 * -80.0F, 1.0F, 0.0F, 0.0F);
                            		break;
                            	case "Table":
                            		GlStateManager.translate(0.1, -0.1, 0.1);
                			        GlStateManager.translate(-d1 / 4, d1 / 5, -d1 / 5);
                			        GlStateManager.rotate(-d1 * 70, 1.4F, -0.5F, 0.7F);
                            		break;
                            	case "Exhibobo":
                            		GlStateManager.rotate(d1 * -45.0F, 2F, 0.8F, 1.0F);
                            		break;
                            	case "Exhibobo2":
                            		 GlStateManager.rotate(d1 * -65.0F, 2F, 0.5F, 1.0F);
                            		break;
                            	case "Swong":
                            		GlStateManager.rotate(d1 * -45.0F, 1.0F, 0.0F, 0.0F);
                	    	        GlStateManager.rotate(d * -20.0F, 0.0F, 1F, 0.0F);
                            		break;
                            	case "Atlas":
                            		GlStateManager.rotate(d1 * -75.0F, 1F, 0, 0.5F);
                 			        GlStateManager.translate(0,  d1 / 8, 0);
                            		break;
                            	case "Tap":
                            		GlStateManager.rotate(d1 * -25.0F, 1.1F, 0.5F, 1.0F);
                			        GlStateManager.translate(-d1 / 20, d1 / 20, -d1 / 20);
                            		break;
                            	case "Throw":
                            		GlStateManager.rotate(d1 * -90.0F, 1F, 0.1f, 0.0F);
                 			        GlStateManager.translate(0, d1 / 5, 0);
                            		break;
                            	}
                            	 GlStateManager.scale(0.4F, 0.4F, 0.4F);
                            }
