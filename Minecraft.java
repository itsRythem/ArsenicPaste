...
import com.arsenicclient.event.impl.misc.KeyEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    {
    	Arsenic.getArsenic().getShuttle().post(new ClientTickEvent());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    Arsenic.getArsenic().getShuttle().post(new KeyEvent(Keyboard.getEventKey() == 0 ? Keyboard.getEventCharacter() + 256 : Keyboard.getEventKey()));
                }
